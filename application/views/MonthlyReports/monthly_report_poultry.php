...
<div class="monthContainer">
              <form  action="<?=base_url('index.php/monthlyRecordController/readPoultry'); ?>" method="post"> 
                  ...
                  <div class="table-responsive">
                    <table class="table table-hover">
                      <tbody>
                        ...
                        <tr>
                          <td>
                            This months expences for poultry farming
                          </td>
                          <td>
                          <?= $expences ?> lkr
                          </td>
                        ...
                        <tr>
                          <td>
                            This months income from poultry farming
                          </td>
                          <td>
                          <?= $income ?> lkr
                          </td>
