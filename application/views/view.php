...
<body>
  ...
  if (isset($cattle)) {
    ...
    foreach ($piggery as $row) {
      $registeredPiggery++;
    }
    foreach ($poultry as $row) {
      $registeredPoultry++;
    }
    foreach ($cattle1 as $row) {
      $submittedCattle++;
    }
    foreach ($goat1 as $row) {
      $submittedGoat++;
    }
    foreach ($piggery1 as $row) {
      $submittedPiggery++;
    }
    foreach ($poultry1 as $row) {
      $submittedPoultry++;
    }
  }
  ...
  <div class="section offset-4 offset-sm-3 offset-md-3">
    ...
    <h1>View</h1>
    <hr>
    <h4 class="card-subtitle mb-2 text-muted"><?php if (!empty($month)) {
                                                echo $month;
                                              } ?></h4>
