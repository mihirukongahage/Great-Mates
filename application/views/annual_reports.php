                    ...
                    <div class="card" style="width: 18rem;">
                        ...
                        <div class="card-body">
                            <div class="text-center">
                                ...
                                <h6 class="card-subtitle mb-2 text-muted">Annual report for cattle</h6>
                            </div>
                        </div>
                    </div>
                </a>
                    ...
                    <div class="card" style="width: 18rem;">
                        ...
                        <div class="card-body">
                            <div class="text-center">
                                ...
                                <h6 class="card-subtitle mb-2 text-muted">Annual report for poultry</h6>
                            </div>
                        </div>
                    </div>
                </a>
                    ...
                    <div class="card" style="width: 18rem;">
                        ...
                        <div class="card-body">
                            <div class="text-center">
                                ...
                                <h6 class="card-subtitle mb-2 text-muted">Annual report for piggery</h6>
                            </div>
                        </div>
                    </div>
                </a>
                    ...
                    <div class="card" style="width: 18rem;">
                        ...
                        <div class="card-body">
                            <div class="text-center">
                                ...
                                <h6 class="card-subtitle mb-2 text-muted">Annual report for goat</h6>
                            </div>
                        </div>
                    </div>
                </a>
